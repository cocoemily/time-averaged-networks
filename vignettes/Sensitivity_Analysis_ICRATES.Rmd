...
save(icrates.net.names.full, file="../Data/icrates_network_names.RData")
...
# Save data on execution time
#write.csv(exec_time, file = "Data/exec_time_nodes_ICRATES.csv")
...
# Save data on execution time
#write.csv(exec_time, file = "Data/exec_time_edges_ICRATES.csv")
